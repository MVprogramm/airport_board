...
const Menu = () => (
  <div className="board__menu">
    <div className="menu__decor menu__decor_left menu__bground_white menu__decor_show"></div>
    ...
    <div className="menu__decor menu__decor_center menu__bground_blue menu__decor_show">
    ...
    <div className="menu__decor menu__decor_right menu__bground_blue menu__decor_show"></div>
  </div>
);
